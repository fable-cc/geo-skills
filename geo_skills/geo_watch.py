...
def scan_and_process(watch_dir, output_dir, processed_dir, platform, brand, dry_run, once, interval):
  ...
  %(prog)s --dir ./input --daemon --interval 10
    ...
    try:
        scan_and_process(
            ...
            args.platform, args.brand, args.dry_run, args.once, args.interval,
        )
